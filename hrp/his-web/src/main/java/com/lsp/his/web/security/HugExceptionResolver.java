...
import com.lsp.his.exception.IHugException;
 ...
 * @author lishupeng
 * @Description
 * @Date 2017/10/24 13:30
 */
public class HugExceptionResolver extends ExceptionHandlerExceptionResolver {

    private final Logger logger = Logger.getLogger(HugExceptionResolver.class);
